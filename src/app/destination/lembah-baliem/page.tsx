        ...
        <SmoothScroll>
            <main className="bg-papua-dark min-h-screen">
                ...
                <DestinationActivities 
                    ...
                    description="Nikmati berbagai aktivitas seru di Lembah Baliem, mulai dari menjelajahi keindahan bawah laut hingga mengabadikan momen di tengah panorama alam yang memukau."
                ...
                <DestinationPreservation 
                    ...
                    description="Sebagai salah satu kawasan megabiodiversitas terpenting di dunia, menjaga kelestarian Lembah Baliem adalah tanggung jawab kita bersama untuk masa depan generasi mendatang."
