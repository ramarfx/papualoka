...
const GALLERY_ITEMS: GalleryItem[] = [
    ...
    { id: 4,  src: "/img/adat/1.png",                              location: "Suku Asmat",      category: "SUKU",    size: "normal" },
    { id: 5,  src: "/img/province/papua-barat-daya/tradition/1-1.png", location: "Tari Yospan",    category: "BUDAYA",  size: "normal" },
    ...
    { id: 8,  src: "/img/province/papua-pegunungan/tradition/1-1.png", location: "Tari Perang",   category: "BUDAYA",  size: "tall" },
    ...
    { id: 13, src: "/img/province/papua-barat/carousel/1.png",    location: "Suku Arfak",      category: "SUKU",    size: "normal" },
    { id: 14, src: "/img/destination/jayawijaya-bg.png",           location: "Jayawijaya",      category: "WISATA",  size: "normal" },
    { id: 15, src: "/img/province/papua-pegunungan/tradition/2-1.png", location: "Bakar Batu",   category: "TRADISI", size: "tall" },
    { id: 16, src: "/img/adat/6.png",                              location: "Rumah Pohon",     category: "SUKU",    size: "tall" },
    { id: 17, src: "/img/alam-papua/3.png",                        location: "Fauna Endemik",   category: "WISATA",  size: "normal" },
    { id: 18, src: "/img/province/papua-selatan/tradition/3-1.png",location: "Ukiran Asmat",    category: "TRADISI", size: "normal" },
    { id: 19, src: "/img/province/papua/tradition/1-1.png",        location: "Tari Isosolo",    category: "BUDAYA",  size: "tall" },
    { id: 20, src: "/img/province/papua-tengah/carousel/2.png",   location: "Suku Kamoro",     category: "SUKU",    size: "normal" },
    { id: 21, src: "/img/province/papua-barat/tradition/1-1.png",  location: "Tari Tumbuk Tanah", category: "BUDAYA", size: "normal" },
    { id: 22, src: "/img/lorentz.png",                             location: "TN Lorentz",      category: "WISATA",  size: "tall" },
    { id: 23, src: "/img/province/papua-selatan/carousel/2.png",   location: "Suku Marind",     category: "SUKU",    size: "normal" },
    { id: 24, src: "/img/province/papua/carousel/1.png",           location: "Suku Sentani",    category: "SUKU",    size: "normal" },
];
