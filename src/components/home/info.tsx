            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 gap-16 lg:gap-8 mt-24 lg:mt-0">
                ...
                >
                    ...
                    <p className="text-white/60 font-sans text-sm md:text-base leading-relaxed mb-10 max-w-xs">
                        Papua dikenal sebagai wilayah paling timur Indonesia
                        dengan kekayaan alam dan budaya yang luar biasa. Beragam
                        suku, bahasa, dan tradisi hidup berdampingan di Tanah
                        Cenderawasih.
                    </p>
                ...
                >
                    <div className="flex flex-col gap-12 relative lg:pt-16 min-w-[280px]">
                        ...
                        {[
                            {
                                title: "300K KM²",
                                desc: "Wilayah luas dengan bentang alam yang beragam.",
                            },
                            {
                                title: "6 Provinsi",
                                desc: "6 provinsi dari pesisir hingga pegunungan.",
                            },
                            {
                                title: "250+ Suku",
                                desc: "Rumah ratusan suku yang menjaga tradisi dan budaya turun-temurun.",
                            },
                        ].map((item, idx) => (
                            <div
                                key={idx}
